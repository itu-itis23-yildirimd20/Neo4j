CREATING DATA : 
// This section creates the Movie Graph database
...
// Find the Person node with the name "Tom Hanks"
...
// Query 4: Find the shortest path (e.g., "Six Degrees of Kevin Bacon")
// Find the shortest path between Tom Hanks and Kevin Bacon
...
// Shows connections to Tom Hanks' supporting cast
